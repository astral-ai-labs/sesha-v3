...
/* ==========================================================================*/
// client.tsx — Client-side aggregator page with resizable panel management
/* ==========================================================================*/
...
interface AggregatorPageClientProps {
  presets: Preset[];
}
...
/**
 * AggregatorPageClient
 *
 * Client component for aggregator page with resizable panels and size tracking.
 * Manages presets panel size state and provides programmatic resizing with dynamic constraints.
 */
function AggregatorPageClient({ presets }: AggregatorPageClientProps) {
...
export default AggregatorPageClient; 